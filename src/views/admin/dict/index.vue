  ...
  <div class="app-container">
    ...
    >
      <template slot="menuLeft">
        <el-button
          v-if="hasPermission('sys_dict_del')"
          class="filter-item"
          type="primary"
      ...
      >
        <el-button
          v-if="hasPermission('sys_dict_add')"
          type="text"
          size="small"
          icon="el-icon-menu"
...
<script>
import {
  addItemObj, addObj, clearDictCache, delItemObj, delObj, fetchItemList, fetchList, putItemObj, putObj
} from '@/api/admin/dict'
...
export default {
  ...
  computed: {
    permissionList() {
      return {
        addBtn: this.vaildData(this.hasPermission('sys_dict_add'), false),
        delBtn: this.vaildData(this.hasPermission('sys_dict_del'), false),
        editBtn: this.vaildData(this.hasPermission('sys_dict_edit'), false)
      }
    }
  },
  methods: {
