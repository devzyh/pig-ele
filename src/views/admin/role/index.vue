  ...
  <div class="app-container">
    ...
    >
      ...
      <template slot="menuLeft">
        <el-button
          v-if="hasPermission('sys_role_add')"
          class="filter-item"
          type="primary"
          icon="el-icon-edit"
        ...
        <el-button
          v-if="hasPermission('sys_role_import_export')"
          class="filter-item"
          plain
          type="primary"
          icon="el-icon-upload"
      ...
      >
        <el-button
          v-if="hasPermission('sys_role_edit')"
          type="text"
          icon="el-icon-edit"
          size="small"
        ...
        <el-button
          v-if="hasPermission('sys_role_perm')"
          type="text"
          size="small"
          icon="el-icon-plus"
        ...
        <el-button
          v-if="hasPermission('sys_role_del')"
          type="text"
          size="small"
          icon="el-icon-delete"
